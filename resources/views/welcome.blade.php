                    ...
                    <div class="tab-pane fade show active" id="tabs-5" role="tabpanel">
                        <div class="row">
                            <div class="vg-slider owl-carousel">
                                ...
                                @else
                                <?php
                               for($i=0;$i<count($trailers)-1;$i++){?>
                                <div class="col-lg-12">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="vg-item large-vg set-bg" data-setbg="{{ asset($trailers[$i]->TrailerPoster) }}">
                                                <a href="{{ url($trailers[$i]->TrailerFile) }}"
                                                    class="play-btn video-popup"><i class="fa fa-play"></i></a>
                                                <div class="vg-text">
                                                    <h5>{{ $trailers[$i]->TrailerTitle }}</h5>
                                                    <ul>
                                                        <li><i class="fa fa-clock-o"></i> {{ ($trailers[$i]->created_at)->toFormattedDateString() }}</li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="vg-item large-vg set-bg" data-setbg="{{ asset($trailers[$i+1]->TrailerPoster) }}">
                                                <a href="{{ url($trailers[$i+1]->TrailerFile) }}"
                                                    class="play-btn video-popup"><i class="fa fa-play"></i></a>
                                                <div class="vg-text">
                                                    <h5>{{ $trailers[$i+1]->TrailerTitle }}</h5>
                                                    <ul>
                                                        <li><i class="fa fa-clock-o"></i> {{ ($trailers[$i+1]->created_at)->toFormattedDateString() }}</li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
